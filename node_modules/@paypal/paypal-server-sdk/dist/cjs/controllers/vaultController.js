...
var VaultController = /** @class */ (function (_super) {
     ...
     */
    VaultController.prototype.paymentTokensCreate = function (_a, requestOptions) {
        var paypalRequestId = _a.paypalRequestId, body = _a.body;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, mapped;
            return tslib_1.__generator(this, function (_b) {
                req = this.createRequest('POST', '/v3/vault/payment-tokens');
                mapped = req.prepareArgs({
                    paypalRequestId: [paypalRequestId, (0, schema_1.string)()],
     ...
     * @return Response from the API call
     */
    VaultController.prototype.customerPaymentTokensGet = function (_a, requestOptions) {
     ...
     * @return Response from the API call
     */
    VaultController.prototype.paymentTokensGet = function (id, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, mapped;
     ...
     * @return Response from the API call
     */
    VaultController.prototype.paymentTokensDelete = function (id, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, mapped;
            return tslib_1.__generator(this, function (_a) {
                req = this.createRequest('DELETE');
                mapped = req.prepareArgs({ id: [id, (0, schema_1.string)()] });
                req.appendTemplatePath(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["/v3/vault/payment-tokens/", ""], ["/v3/vault/payment-tokens/", ""])), mapped.id);
                req.throwOn(400, customError_1.CustomError, 'Request is not well-formed, syntactically incorrect, or violates schema.');
                req.throwOn(403, customError_1.CustomError, 'Authorization failed due to insufficient permissions.');
                req.throwOn(500, customError_1.CustomError, 'An internal server error has occurred.');
                req.authenticate([{ oauth2: true }]);
     ...
     * @return Response from the API call
     */
    VaultController.prototype.setupTokensCreate = function (_a, requestOptions) {
        var paypalRequestId = _a.paypalRequestId, body = _a.body;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, mapped;
            return tslib_1.__generator(this, function (_b) {
     ...
     * @return Response from the API call
     */
    VaultController.prototype.setupTokensGet = function (id, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, mapped;
            return tslib_1.__generator(this, function (_a) {
                req = this.createRequest('GET');
                mapped = req.prepareArgs({ id: [id, (0, schema_1.string)()] });
                req.appendTemplatePath(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["/v3/vault/setup-tokens/", ""], ["/v3/vault/setup-tokens/", ""])), mapped.id);
                req.throwOn(403, customError_1.CustomError, 'Authorization failed due to insufficient permissions.');
                req.throwOn(404, customError_1.CustomError, 'The specified resource does not exist.');
                req.throwOn(422, customError_1.CustomError, 'The requested action could not be performed, semantically incorrect, or failed business validation.');
                req.throwOn(500, customError_1.CustomError, 'An internal server error has occurred.');
