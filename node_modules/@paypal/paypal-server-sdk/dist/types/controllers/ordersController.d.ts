...
export declare class OrdersController extends BaseController {
     ...
     */
    ordersCreate({ body, paypalRequestId, paypalPartnerAttributionId, paypalClientMetadataId, prefer, paypalAuthAssertion, }: {
        body: OrderRequest;
     ...
     * @return Response from the API call
     */
    ordersGet({ id, paypalAuthAssertion, fields, }: {
        id: string;
        paypalAuthAssertion?: string;
        fields?: string;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<Order>>;
     ...
     * @return Response from the API call
     */
    ordersPatch({ id, paypalAuthAssertion, body, }: {
        id: string;
        paypalAuthAssertion?: string;
        body?: Patch[];
     ...
     * @return Response from the API call
     */
    ordersConfirm({ id, paypalClientMetadataId, paypalAuthAssertion, prefer, body, }: {
        id: string;
        paypalClientMetadataId?: string;
        paypalAuthAssertion?: string;
        prefer?: string;
     ...
     * @return Response from the API call
     */
    ordersAuthorize({ id, paypalRequestId, prefer, paypalClientMetadataId, paypalAuthAssertion, body, }: {
        id: string;
        paypalRequestId?: string;
        prefer?: string;
        paypalClientMetadataId?: string;
     ...
     * @return Response from the API call
     */
    ordersCapture({ id, paypalRequestId, prefer, paypalClientMetadataId, paypalAuthAssertion, body, }: {
        id: string;
        paypalRequestId?: string;
        prefer?: string;
        paypalClientMetadataId?: string;
     ...
     * @return Response from the API call
     */
    ordersTrackCreate({ id, body, paypalAuthAssertion, }: {
        id: string;
     ...
     * @return Response from the API call
     */
    ordersTrackersPatch({ id, trackerId, paypalAuthAssertion, body, }: {
        id: string;
        trackerId: string;
        paypalAuthAssertion?: string;
        body?: Patch[];
