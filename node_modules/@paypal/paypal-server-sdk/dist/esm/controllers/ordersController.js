...
export class OrdersController extends BaseController {
     ...
     */
    async ordersCreate({ body, paypalRequestId, paypalPartnerAttributionId, paypalClientMetadataId, prefer, paypalAuthAssertion, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async ordersGet({ id, paypalAuthAssertion, fields, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async ordersPatch({ id, paypalAuthAssertion, body, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async ordersConfirm({ id, paypalClientMetadataId, paypalAuthAssertion, prefer, body, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async ordersAuthorize({ id, paypalRequestId, prefer, paypalClientMetadataId, paypalAuthAssertion, body, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            id: [id, string()],
            paypalRequestId: [paypalRequestId, optional(string())],
     ...
     * @return Response from the API call
     */
    async ordersCapture({ id, paypalRequestId, prefer, paypalClientMetadataId, paypalAuthAssertion, body, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            id: [id, string()],
            paypalRequestId: [paypalRequestId, optional(string())],
     ...
     * @return Response from the API call
     */
    async ordersTrackCreate({ id, body, paypalAuthAssertion, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            id: [id, string()],
     ...
     * @return Response from the API call
     */
    async ordersTrackersPatch({ id, trackerId, paypalAuthAssertion, body, }, requestOptions) {
        const req = this.createRequest('PATCH');
        const mapped = req.prepareArgs({
            id: [id, string()],
