 ...
 */
import { customerVaultPaymentTokensResponseSchema, } from '../models/customerVaultPaymentTokensResponse';
import { paymentTokenRequestSchema, } from '../models/paymentTokenRequest';
import { paymentTokenResponseSchema, } from '../models/paymentTokenResponse';
import { setupTokenRequestSchema, } from '../models/setupTokenRequest';
import { setupTokenResponseSchema, } from '../models/setupTokenResponse';
...
export class VaultController extends BaseController {
     ...
     */
    async paymentTokensCreate({ paypalRequestId, body, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async customerPaymentTokensGet({ customerId, pageSize, page, totalRequired, }, requestOptions) {
        ...
        req.throwOn(500, CustomError, 'An internal server error has occurred.');
        req.authenticate([{ oauth2: true }]);
        return req.callAsJson(customerVaultPaymentTokensResponseSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async paymentTokensGet(id, requestOptions) {
     ...
     * @return Response from the API call
     */
    async paymentTokensDelete(id, requestOptions) {
     ...
     * @return Response from the API call
     */
    async setupTokensCreate({ paypalRequestId, body, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async setupTokensGet(id, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({ id: [id, string()] });
