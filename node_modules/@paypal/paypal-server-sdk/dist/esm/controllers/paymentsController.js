 ...
 */
import { capturedPaymentSchema, } from '../models/capturedPayment';
import { captureRequestSchema } from '../models/captureRequest';
import { paymentAuthorizationSchema, } from '../models/paymentAuthorization';
import { reauthorizeRequestSchema, } from '../models/reauthorizeRequest';
import { refundSchema } from '../models/refund';
import { refundRequestSchema } from '../models/refundRequest';
...
export class PaymentsController extends BaseController {
     ...
     */
    async authorizationsGet({ authorizationId, paypalAuthAssertion, }, requestOptions) {
        ...
        req.throwOn(404, CustomError, 'The request failed because the resource does not exist.');
     ...
     * @return Response from the API call
     */
    async authorizationsCapture({ authorizationId, paypalRequestId, prefer, paypalAuthAssertion, body, }, requestOptions) {
        ...
        req.throwOn(400, CustomError, 'The request failed because it is not well-formed or is syntactically incorrect or violates schema.');
        req.throwOn(401, CustomError, 'Authentication failed due to missing authorization header, or invalid authentication credentials.');
        req.throwOn(403, CustomError, 'The request failed because the caller has insufficient permissions.');
        req.throwOn(404, CustomError, 'The request failed because the resource does not exist.');
        req.throwOn(409, CustomError, 'The server has detected a conflict while processing this request.');
        req.throwOn(422, CustomError, 'The request failed because it is semantically incorrect or failed business validation.');
        req.throwOn(500, ApiError, 'The request failed because an internal server error occurred.');
        req.defaultToError(CustomError, 'The error response.');
        req.authenticate([{ oauth2: true }]);
     ...
     * @return Response from the API call
     */
    async authorizationsReauthorize({ authorizationId, paypalRequestId, prefer, paypalAuthAssertion, body, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            authorizationId: [authorizationId, string()],
            paypalRequestId: [paypalRequestId, optional(string())],
        ...
        req.throwOn(401, CustomError, 'Authentication failed due to missing authorization header, or invalid authentication credentials.');
        req.throwOn(404, CustomError, 'The request failed because the resource does not exist.');
        req.throwOn(422, CustomError, 'The request failed because it either is semantically incorrect or failed business validation.');
        req.throwOn(500, ApiError, 'The request failed because an internal server error occurred.');
        req.defaultToError(CustomError, 'The error response.');
        req.authenticate([{ oauth2: true }]);
        return req.callAsJson(paymentAuthorizationSchema, requestOptions);
     ...
     * @return Response from the API call
     */
    async authorizationsVoid({ authorizationId, paypalAuthAssertion, paypalRequestId, prefer, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            authorizationId: [authorizationId, string()],
            paypalAuthAssertion: [paypalAuthAssertion, optional(string())],
        ...
        req.throwOn(403, CustomError, 'The request failed because the caller has insufficient permissions.');
        req.throwOn(404, CustomError, 'The request failed because the resource does not exist.');
        req.throwOn(409, CustomError, 'The request failed because a previous call for the given resource is in progress.');
        req.throwOn(422, CustomError, 'The request failed because it either is semantically incorrect or failed business validation.');
        req.throwOn(500, ApiError, 'The request failed because an internal server error occurred.');
        req.defaultToError(CustomError, 'The error response.');
        req.authenticate([{ oauth2: true }]);
     ...
     * @return Response from the API call
     */
    async capturesGet(captureId, requestOptions) {
        const req = this.createRequest('GET');
     ...
     * @return Response from the API call
     */
    async capturesRefund({ captureId, paypalRequestId, prefer, paypalAuthAssertion, body, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
     ...
     * @return Response from the API call
     */
    async refundsGet({ refundId, paypalAuthAssertion, }, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
